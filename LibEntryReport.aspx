<%@ Page Language="VB" MasterPageFile="~/CMaster.master" AutoEventWireup="false" CodeFile="LibEntryReport.aspx.vb" Inherits="LibEntryReport" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label1" CssClass="alert-info" runat="server" BackColor="#055FA5" Font-Bold="True" style="text-align:center"
        Font-Size="Large" ForeColor="White" Text="Library Entry Report"
                    Width="100%"></asp:Label>
